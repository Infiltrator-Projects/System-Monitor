...
support/tests contains extensive accounting, hardware, Bluetooth, GPU, battery, filesystem, history, portability and Common-integration smoke/contract coverage, with CMake and Make validation paths.
