...
void gtk_grid_attach(GtkGrid*,GtkWidget*,gint,gint,gint,gint); GtkWidget *gtk_grid_new(void); void gtk_grid_set_column_homogeneous(GtkGrid*,gboolean); void gtk_grid_set_column_spacing(GtkGrid*,guint); void gtk_grid_set_row_spacing(GtkGrid*,guint);
GtkWidget *gtk_label_new(const gchar*); void gtk_label_set_selectable(GtkLabel*,gboolean); void gtk_label_set_attributes(GtkLabel*,PangoAttrList*); void gtk_label_set_ellipsize(GtkLabel*,PangoEllipsizeMode); void gtk_label_set_width_chars(GtkLabel*,gint); void gtk_label_set_max_width_chars(GtkLabel*,gint); void gtk_label_set_line_wrap(GtkLabel*,gboolean); void gtk_label_set_markup(GtkLabel*,const gchar*); void gtk_label_set_text(GtkLabel*,const gchar*); const gchar *gtk_label_get_text(GtkLabel*);
...
void gtk_style_context_add_provider_for_screen(GdkScreen*,GtkStyleProvider*,guint); void gtk_style_context_remove_provider_for_screen(GdkScreen*,GtkStyleProvider*); void gtk_style_context_add_class(GtkStyleContext*,const gchar*); void gtk_style_context_remove_class(GtkStyleContext*,const gchar*); gboolean gtk_style_context_lookup_color(GtkStyleContext*,const gchar*,GdkRGBA*); void gtk_style_context_get_background_color(GtkStyleContext*,GtkStateFlags,GdkRGBA*);
