...
void gtk_style_context_add_provider_for_screen(GdkScreen*,GtkStyleProvider*,guint); void gtk_style_context_remove_provider_for_screen(GdkScreen*,GtkStyleProvider*); void gtk_style_context_add_class(GtkStyleContext*,const gchar*); gboolean gtk_style_context_lookup_color(GtkStyleContext*,const gchar*,GdkRGBA*); void gtk_style_context_get_background_color(GtkStyleContext*,GtkStateFlags,GdkRGBA*);
