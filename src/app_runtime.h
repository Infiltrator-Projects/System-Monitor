 ...
 */
#ifndef INFILTRATOR_SYSTEM_MONITOR_APP_RUNTIME_H
#define INFILTRATOR_SYSTEM_MONITOR_APP_RUNTIME_H
 ...
 * to discover that their widgets do not exist.
 *
 * @param [in,out] app Active application context.
 * @param [in] page Newly constructed notebook page.
 */
