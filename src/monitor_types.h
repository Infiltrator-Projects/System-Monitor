 ...
 */
#ifndef INFILTRATOR_SYSTEM_MONITOR_MONITOR_TYPES_H
#define INFILTRATOR_SYSTEM_MONITOR_MONITOR_TYPES_H
...
/** Linux-style pressure-stall averages normalised to percentages. */
typedef struct {
    bool available;                 /**< At least the "some" pressure line was parsed. */
    double some_avg10;              /**< Share of wall time stalled over the last 10 s. */
    double some_avg60;              /**< Share of wall time stalled over the last 60 s. */
    double some_avg300;             /**< Share of wall time stalled over the last 300 s. */
    uint64_t some_total_us;         /**< Cumulative "some" stall time in microseconds. */
    bool full_available;            /**< A "full" pressure line is supplied for this resource. */
    double full_avg10;              /**< Complete-stall share over the last 10 s. */
    double full_avg60;              /**< Complete-stall share over the last 60 s. */
    double full_avg300;             /**< Complete-stall share over the last 300 s. */
    uint64_t full_total_us;         /**< Cumulative "full" stall time in microseconds. */
} LsmPressureInfo;
...
typedef struct {
    ...
    LsmPressureInfo cpu_pressure;
    LsmPressureInfo memory_pressure;
    LsmPressureInfo io_pressure;
