...
static const HelpTopic topics[] = {
    ...
    },
    {
        ...
        "On Linux, the CPU, Memory and Disk Performance pages also show kernel Pressure Stall "
        "Information: it measures time work was delayed by CPU, memory or I/O contention rather "
        "than merely how busy the resource was. Open the Process Inspector for a suspected "
        "process and inspect its live graph, open files, threads and memory map before deciding "
        "whether to end it."
    }
};
