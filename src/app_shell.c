...
void lsm_app_shell_apply_theme(LsmApp *app)
{
    ...
    g_string_append(
        ...
        " alpha(#8b2de2, 0.20));"
        " border: 1px solid alpha(#26c7ff, 0.48);"
        " box-shadow: 0 2px 12px alpha(#00adef, 0.10);"
        "}"
        "#lsm-overview-brand-mark {"
        " min-width: 52px; min-height: 52px;"
        " background-image: radial-gradient(circle, alpha(#00e5ff, 0.22),"
        " alpha(#6d3cff, 0.12));"
        ...
        " color: @lsm_heading;"
        " background-image: linear-gradient(to right, alpha(#007acb, 0.10), alpha(@lsm_neutral, 0.035));"
        " border: 1px solid alpha(@lsm_connection_border, 0.38);"
        " border-radius: 7px; padding: 7px 9px;"
        "}"
        ".lsm-overview-process-name { color: @lsm_title; font-weight: 650; }"
        ".lsm-overview-process-cpu { color: #4bd8ff; font-weight: 700; }"
        ".lsm-overview-process-memory { color: @lsm_summary; }"
        ".lsm-overview-process-bar trough { min-height: 8px; background-color: alpha(@lsm_neutral, 0.12); border-radius: 999px; }"
        ".lsm-overview-process-bar progress { min-height: 8px; background-image: linear-gradient(to right, #00adef, #7a63ff); border-radius: 999px; }"
